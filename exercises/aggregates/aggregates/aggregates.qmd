...
```
**Answer** I see the advanced box score statistics from the past NBA season for each NBA player. Some players who played on multiple teams have multiple rows.
...
**Answer** The most commonly played position is SG. Secondly is C, closely followed by SF. The bottom two positions are PF and PG, with 121 and 115 players, respectively.
...
**Answer** Some players were traded during the season and had different positions for each team, resulting in their listed position being "PF-C", or something with a '-' in it. This could be resolved by removing the "TOT" rows for players who were traded.
...
The most interesting position is, in my opinion, the shooting guard. It is not as talked about as the center position in terms of whether it is dying or not, but I think the question is just as valid for the position. It is the most commonly played position yet it has the second-lowest average minutes played. I think this is because most shooting guards in the NBA either transition to point guard because of how gifted offensively they are (for example, James Harden) or they are off-ball role players who typically play less. There no longer are many superstars who primarily play shooting guard; if you play shooting guard nowadays you're typically someone whose playmaking is still a work-in-progress or you just never needed to be the point guard for your team.